#!/usr/bin/python
# This script stops the software pack
...
def main(argv):
  ...
  bsl_util.log_info(f"==========================")
  bsl_util.log_info(f"Pack Stopping")
  ...
  # =======
  bsl_util.log_task_started("Stopping docker container...")
  bsl_util.run_sys_cmd(f'docker rm {pack_name} -f')
